...
class BacktestTradingSession(TradingSession):
    ...
    def __init__(self, code=None, start_time=None, end_time=None, daily_start_time='09:30:00', deal_volume_time=None,
                 keep_order_time=10,
    ...
    def _create_broker(self):
        ...
        broker = SimulatedBroker(self.start_day, self.data_handler,
                                 ...
                                 initial_cash=self.initial_cash, initial_position=self.initial_position,
    ...
    def get_period(self):
        ...
        period = 240 * sum(self.broker.data_handler.data_source.data_info['NK'].values()) // len(
            self.broker.data_handler.data_source.data_info['NK'])
    ...
    def run(self, results=False):
        ...
        for iday in self.data_handler.data_source.data_info['Days']:
            ...
            acomplished = round(self.broker.data_handler.data_source.data_info['Days'].index(iday) /
                                self.broker.data_handler.data_source.data_info['NDay'] * 100, 2)
